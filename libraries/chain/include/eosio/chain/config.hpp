...
const static uint32_t   default_max_block_net_usage_origin           = 1024 * 1024; /// at 500ms blocks and 200byte trx, this enables ~10,000 TPS burst
const static uint32_t   default_max_block_net_usage                  = 6 * 1024 * 1024; /// at 500ms blocks and 200byte trx, this enables ~10,000 TPS burst
const static uint32_t   default_target_block_net_usage_pct           = 10 * percent_1; /// we target 1000 TPS
const static uint32_t   default_max_transaction_net_usage_origin     = default_max_block_net_usage_origin / 2;
...
// BP Output block interval adjustment 
const static uint32_t   default_max_block_cpu_usage_origin          = 200'000; /// max block cpu usage in microseconds
const static uint32_t   default_max_block_cpu_usage                 = 6 * 200'000; /// max block cpu usage in microseconds
const static uint32_t   default_target_block_cpu_usage_pct          = 10 * percent_1;
const static uint32_t   default_max_transaction_cpu_usage_origin    = 3*default_max_block_cpu_usage_origin/4; /// max trx cpu usage in microseconds
